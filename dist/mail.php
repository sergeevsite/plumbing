...
$mail->Username = 'genadiy.drobov@mail.ru'; // Ваш логин от почты с которой будут отправляться письма
$mail->Password = 'FD3ddD39ls2'; // Ваш пароль от почты с которой будут отправляться письма
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465; // TCP port to connect to / этот порт может отличаться у других провайдеров

$mail->setFrom('genadiy.drobov@mail.ru'); // от кого будет уходить письмо?
...
$mail->Body    = '' .$name . ' Отправил(а) заявку с сайта. <br> Номер телефона: ' .$phone;
$mail->AltBody = '';
